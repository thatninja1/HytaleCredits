...
public final class MariaDbCreditsRepository extends JdbcCreditsRepository {
    public MariaDbCreditsRepository(CreditConfig.MysqlSettings settings, Logger logger, boolean debug) {
        super(
                "mariadb",
                "jdbc:mariadb://" + settings.host() + ":" + settings.port() + "/" + settings.database() + "?useSSL=" + settings.useSSL(),
                settings.username(),
                settings.password(),
